	 ...
	 <div class="market-updates">
            ...
            <div class="col-md-9 col-xs-12">
             ...
             <br>
									...
									<div class="form-group">
										<textarea name="catdesc" placeholder="Enter category Description" required="" class="form-control"></textarea>
									
									</div>

									<div class="form-group">
										<input type="submit" name="addcategory" value="AddCategory!" class="btn btn-success btn-lg">					</div>
									</form>
